                        ...
                        <table id="tabla" class="table table-bordered table-striped">
                            ...
                            @foreach($listado as $dato)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/proadministrador/visualizar/documento/'.$dato->id) }}" target="_blank" class="btn btn-info btn-xs">
                                            <i class="fa fa-file-pdf"></i> Ver PDF
                                        </a>

                                        <a href="{{ url('/admin/proadministrador/descargar/documento/'.$dato->id) }}" class="btn btn-info btn-xs">
