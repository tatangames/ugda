...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            let id = {{ $id }};
            var ruta = "{{ URL::to('/admin/prosolicitante/tabla') }}/" + id;
    ...
    <script>
        ...
        function nuevoRegistro(){
            ...
            axios.post(url+'/prosolicitante/nuevo', formData, {
            })
                .then((response) => {
                    closeLoading();
        ...
        function borrarSolicitud(id){
            ...
            axios.post(url+'/prosolicitante/borrar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
        ...
        function infoEditar(id){
            ...
            axios.post(url+'/prosolicitante/informacion', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
        ...
        function actualizarDatos(){
            ...
            axios.post(url+'/prosolicitante/editar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
