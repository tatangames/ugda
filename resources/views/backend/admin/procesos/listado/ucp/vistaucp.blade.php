        ...
        <div class="container-fluid">
            <div class="card card-gray-dark">
                <div class="card-header">
                    <h3 class="card-title">Listado de Procesos UCP</h3>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="select-estado">
                                            <option value="0">Adjudicado</option>
                                    ...
                                    <div class="form-group">
                                        <label>Empresa</label>
                                        <select class="form-control" id="select-empresas" style="height: 150px" multiple="multiple">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label>Estado</label>
                                        <select class="form-control" id="select-estado-editar">
                                            <option value="0">Adjudicado</option>
                                            <option value="1">Desierto</option>
                                        </select>
                                    </div>
...
@section('archivos-js')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            let id = {{ $id }};
            var ruta = "{{ URL::to('/admin/proucp/tabla') }}/" + id;
    ...
    <script>
        ...
        function nuevoRegistro(){
            ...
            var selected = [];
            for (var option of document.getElementById('select-empresas').options) {
                if (option.selected) {
            ...
            formData.append('empresas', JSON.stringify(selected));

            axios.post(url+'/proucp/nuevo', formData, {
            })
                .then((response) => {
        ...
        function borrarSolicitud(id){
            ...
            axios.post(url+'/proucp/borrar', formData, {
            })
                .then((response) => {
                    closeLoading();
                    if(response.data.success === 1){
